...
* **jsDelivr** ([browse](https://cdn.jsdelivr.net/npm/typesense-minibar@1.0.1/)):<br>[typesense-minibar.js](https://cdn.jsdelivr.net/npm/typesense-minibar@1.0.1/typesense-minibar.js), [typesense-minibar.css](https://cdn.jsdelivr.net/npm/typesense-minibar@1.0.1/typesense-minibar.css)
* **UNPKG** ([browse](https://unpkg.com/browse/typesense-minibar@1.0.1/)):<br>[typesense-minibar.js](https://unpkg.com/typesense-minibar@1.0.1/typesense-minibar.js), [typesense-minibar.css](https://unpkg.com/typesense-minibar@1.0.1/typesense-minibar.css)
